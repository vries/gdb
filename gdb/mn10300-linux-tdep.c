			     ...
			     int regnum, void *gregs, size_t len)
{
  ...
  switch (regnum) {
  case E_D0_REGNUM:
    regcache->deprecated_raw_collect (E_D0_REGNUM,
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_D0));
    break;
  case E_D1_REGNUM:
    regcache->deprecated_raw_collect (E_D1_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_D1));
    break;
  case E_D2_REGNUM:
    regcache->deprecated_raw_collect (E_D2_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_D2));
    break;
  case E_D3_REGNUM:
    regcache->deprecated_raw_collect (E_D3_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_D3));
    break;
  case E_A0_REGNUM:
    regcache->deprecated_raw_collect (E_A0_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_A0));
    break;
  case E_A1_REGNUM:
    regcache->deprecated_raw_collect (E_A1_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_A1));
    break;
  case E_A2_REGNUM:
    regcache->deprecated_raw_collect (E_A2_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_A2));
    break;
  case E_A3_REGNUM:
    regcache->deprecated_raw_collect (E_A3_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_A3));
    break;
  case E_SP_REGNUM:
    regcache->deprecated_raw_collect (E_SP_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_SP));
    break;
  case E_PC_REGNUM:
    regcache->deprecated_raw_collect (E_PC_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_PC));
    break;
  case E_MDR_REGNUM:
    regcache->deprecated_raw_collect (E_MDR_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_MDR));
    break;
  case E_PSW_REGNUM:
    regcache->deprecated_raw_collect (E_PSW_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_EPSW));
    break;
  case E_LIR_REGNUM:
    regcache->deprecated_raw_collect (E_LIR_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_LIR));
    break;
  case E_LAR_REGNUM:
    regcache->deprecated_raw_collect (E_LAR_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_LAR));
    break;
  case E_MDRQ_REGNUM:
    regcache->deprecated_raw_collect (E_MDRQ_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_MDRQ));
    break;
  case E_E0_REGNUM:
    regcache->deprecated_raw_collect (E_E0_REGNUM,   
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E0));
    break;
  case E_E1_REGNUM:
    regcache->deprecated_raw_collect (E_E1_REGNUM,
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E1));
    break;
  case E_E2_REGNUM:
    regcache->deprecated_raw_collect (E_E2_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E2));
    break;
  case E_E3_REGNUM:
    regcache->deprecated_raw_collect (E_E3_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E3));
    break;
  case E_E4_REGNUM:
    regcache->deprecated_raw_collect (E_E4_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E4));
    break;
  case E_E5_REGNUM:
    regcache->deprecated_raw_collect (E_E5_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E5));
    break;
  case E_E6_REGNUM:
    regcache->deprecated_raw_collect (E_E6_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E6));
    break;
  case E_E7_REGNUM:
    regcache->deprecated_raw_collect (E_E7_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_E7));
    break;
  ...
  case E_E10_REGNUM:
    ...
    break;
  case E_MCRH_REGNUM:
    regcache->deprecated_raw_collect (E_MCRH_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_MCRH));
    break;
  case E_MCRL_REGNUM:
    regcache->deprecated_raw_collect (E_MCRL_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_MCRL));
    break;
  case E_MCVF_REGNUM:
    regcache->deprecated_raw_collect (E_MCVF_REGNUM, 
			   (regp + MN10300_ELF_GREGSET_T_REG_INDEX_MCVF));
    break;
  case E_FPCR_REGNUM:
    /* FPCR is numbered among the GP regs, but handled as an FP reg.
			      ...
			      int regnum, void *fpregs, size_t len)
{
  ...
  if (regnum == -1)
    ...
    regcache->deprecated_raw_collect (E_FPCR_REGNUM, &fpregset->fpcr);
  else if (E_FS0_REGNUM <= regnum
	   && regnum < E_FS0_REGNUM + MN10300_ELF_NFPREG)
    regcache->deprecated_raw_collect (regnum, &fpregset->fpregs[regnum - E_FS0_REGNUM]);
