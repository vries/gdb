...
#line 1647 "p-exp.c.tmp"
    break;

  case 25: /* arglist: exp  */
#line 346 "p-exp.y"
                        { pstate->arglist_len = 1; }
#line 1653 "p-exp.c.tmp"
    break;

  case 26: /* arglist: arglist ',' exp  */
#line 348 "p-exp.y"
                        { pstate->arglist_len++; }
#line 1659 "p-exp.c.tmp"
    break;
...
#line 366 "p-exp.y"
                        { }
#line 1681 "p-exp.c.tmp"
    break;

  case 29: /* exp: exp '*' exp  */
#line 372 "p-exp.y"
                        { pstate->wrap2<mul_operation> (); }
#line 1687 "p-exp.c.tmp"
    break;
...
#line 1721 "p-exp.c.tmp"
    break;

  case 33: /* exp: exp MOD exp  */
#line 401 "p-exp.y"
                        { pstate->wrap2<rem_operation> (); }
#line 1727 "p-exp.c.tmp"
    break;

  case 34: /* exp: exp '+' exp  */
#line 405 "p-exp.y"
                        { pstate->wrap2<add_operation> (); }
#line 1733 "p-exp.c.tmp"
    break;

  case 35: /* exp: exp '-' exp  */
#line 409 "p-exp.y"
                        { pstate->wrap2<sub_operation> (); }
#line 1739 "p-exp.c.tmp"
    break;

  case 36: /* exp: exp LSH exp  */
#line 413 "p-exp.y"
                        { pstate->wrap2<lsh_operation> (); }
#line 1745 "p-exp.c.tmp"
    break;
...
#line 613 "p-exp.y"
			  ...
			  if ((yyvsp[0].ssym).sym.symbol != 0)
			  ...
			  else
			    {
			      ...
			      if (tem)
				(yyval.bval) = BLOCKVECTOR_BLOCK (tem->blockvector (),
							STATIC_BLOCK);
			      else
...
#line 2123 "p-exp.c.tmp"
    break;

  case 69: /* typebase: TYPENAME  */
#line 760 "p-exp.y"
                        { (yyval.tval) = (yyvsp[0].tsym).type; }
#line 2129 "p-exp.c.tmp"
    break;
