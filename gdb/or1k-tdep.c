		   ...
		   gdb_byte *readbuf, const gdb_byte *writebuf)
{
  ...
  if (rv_size <= bpw)
      ...
      if (writebuf != NULL)
	{
	  ...
	  regcache->deprecated_cooked_write (OR1K_RV_REGNUM, buf);
      ...
      if (writebuf != NULL)
	{
	  ...
	  regcache->deprecated_cooked_write (OR1K_RV_REGNUM, buf_hi);
	  regcache->deprecated_cooked_write (OR1K_RV_REGNUM + 1, buf_lo);
